 ...
 */
public class GosNetworkService extends IntentService {
    ...
    public GosNetworkService(String name) {
        super(name);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (request.getMethod().equalsIgnoreCase(GosServerApi.GOS_METHODS.POST))
            response = callPost(request);
        else if (request.getMethod().equalsIgnoreCase(GosServerApi.GOS_METHODS.GET))
    ...
    private void sendBroadcastResult(GosRequest request, GosResponse response) {
        ...
        Intent broadcastIntent = null;
            ...
            switch (request.getRequestAction()) {
                ...
                case GosServerApi.GOS_REQUESTS.GET_CARD_LIST:
                    ...
                    break;
                case GosServerApi.GOS_REQUESTS.ADD_CARD:
                ...
                case GosServerApi.GOS_REQUESTS.INIT_PAYMENT:
                    broadcastIntent = new Intent(NetworkContract.ACTION_INIT_PAYMENT)
                            .putExtra(NetworkContract.KEY_RESPONSE, gson.toJson(response, GosResponse.class));
                    break;
                case GosServerApi.GOS_REQUESTS.CONFIRM_PAYMENT:
