...
public class AddCardParameterUnitTest {
    ...
    public void AddCardFieldsTest() throws Exception{
        ...
        thrown.expect(GosInvalidCardFieldsException.class);
         CardFields.create(4111111111111111l,"01","19","144", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111l,"13","19","144", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111l,"01","15","144", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111l,"01","19","44", null);
        CardFields.create(4111111111111111l,null,"19","144", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111L,"01",null,"144", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111l,"01","19",null, null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(0,"01","19","144", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111l,"01","19","1441", null);
        thrown.expect(GosInvalidCardFieldsException.class);
        CardFields.create(4111111111111111l,"01","19","144", null);
         //CardFields.create(4111111111111111l,"01","19","144", null);
